...
gtest: Record.o Comparison.o ComparisonEngine.o Schema.o File.o FileHandler.o DBFile.o y.tab.o lex.yy.o gtest-all.o gtest.o
	$(CC) -o gtest Record.o Comparison.o ComparisonEngine.o Schema.o File.o FileHandler.o DBFile.o y.tab.o lex.yy.o gtest-all.o gtest.o -lfl -lpthread 
...
test.out: Record.o Comparison.o ComparisonEngine.o Schema.o File.o FileHandler.o DBFile.o y.tab.o lex.yy.o test.o
	$(CC) -o test.out Record.o Comparison.o ComparisonEngine.o Schema.o File.o FileHandler.o DBFile.o y.tab.o lex.yy.o test.o -lfl

main: Record.o Comparison.o ComparisonEngine.o Schema.o File.o FileHandler.o DBFile.o y.tab.o lex.yy.o main.o
	$(CC) -o main Record.o Comparison.o ComparisonEngine.o Schema.o File.o FileHandler.o DBFile.o y.tab.o lex.yy.o main.o -lfl
...
y.tab.o: Parser.y
	yacc -d Parser.y
	sed $(tag) y.tab.c -e "s/  _attribute_ ((_unused))$$/# ifndef __cplusplus\n  __attribute_ ((_unused_));\n# endif/"
	g++ -c y.tab.c
